...
\newcommand{\reviewer}{Prof.\ Myra\ Spiliopoulou}
\newcommand{\departmentone}{\ifgerman{Institut für Technische und Betriebliche Informationssysteme}{Department of Technical and Operative Information Systems}}

\newcommand{\advisorone}{Daniel\ Kottke}
\newcommand{\advisortwo}{Dr.\ Georg\ Krempl}
...
\ifgerman{
	...
	\newcommand{\thedate}{December 23, 2015}
}
