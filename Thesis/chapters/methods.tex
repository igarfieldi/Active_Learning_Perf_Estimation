...
\begin{algorithm}[h]
	\begin{algorithmic}[1]
		...
		\State {}
		\Comment {but we still need it in the set}
...
\begin{figure}[h]
	\centering
	\includegraphics[trim = 0cm 6cm 0cm 5cm, clip = true, width = 0.9\textwidth]{allFunctions}
