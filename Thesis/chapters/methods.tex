...
\begin{figure}[h]
	\centering
	\includegraphics[trim = 2cm 7cm 2cm 6cm, clip = true, width = 0.48\textwidth]{weightingDiff}
	\includegraphics[trim = 2cm 7cm 2cm 6cm, clip = true, width = 0.48\textwidth]{fitNIRate}
