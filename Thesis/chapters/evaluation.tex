...
Some of the methods in \ref{methods} require parameters to operate properly. As reading them in text form seems troublesome, the parameters used are listed in 
...
\begin{table}[htbp]
	...
	\begin{tabular}{c | c | c}
		...
		\hline
		\multirow{2}{*}{\textit{Testing}} & \multicolumn{1}{c |}{Iterations} & \multicolumn{1}{c}{30} \\
		\cline{2-3}
		& \multicolumn{1}{c |}{Runs} & \multicolumn{1}{c}{100} \\
		\hline
		\multirow{2}{*}{\textit{Sub-sampling}} & \multicolumn{1}{c |}{Cap} & \multicolumn{1}{c}{10000} \\
		\cline{2-3}
		& \multicolumn{1}{c |}{Paths} & \multicolumn{1}{c}{$|X_T|^2$ (capped at 10000)} \\
		\hline
		\multirow{2}{*}{\textit{Subset Estimation}} & \multicolumn{1}{c |}{Folds for CV} & \multicolumn{1}{c}{5} \\
		\cline{2-3}
		& \multicolumn{1}{c |}{Bootstrap samples} & \multicolumn{1}{c}{50} \\
		\hline
		\multirow{5}{*}{\textit{Function fitting}} & \multicolumn{1}{c |}{Number of iterations} & \multicolumn{1}{c}{300} \\
		\cline{2-3}
		& \multicolumn{1}{c |}{Max. parameter change} & \multicolumn{1}{c}{0.0001} \\
		& \multicolumn{1}{c |}{Initial params. (exp.)} & \multicolumn{1}{c}{$\{[0,1], [-2,0], [-2,0]\}$} \\
		& \multicolumn{1}{c |}{Initial params. (sig.)} & \multicolumn{1}{c}{$\{[0,1], [0,1], [-4,4]\}$} \\
		& \multicolumn{1}{c |}{Initial params. (lin.)} & \multicolumn{1}{c}{$\{[0,1], [0,4]\}$} \\
		\hline
	\end{tabular}
